...
import br.com.boardproject.service.BoardColumnQueryService;
import br.com.boardproject.service.BoardQueryService;
import br.com.boardproject.service.CardQueryService;
import br.com.boardproject.service.CardService;
...
public class BoardMenu {
    ...
    private void cancelCard() throws SQLException{
        System.out.println("Informe o id do card que deseja mover para a proxima coluna de cancelamento");
        var cardId = scanner.nextLong();
    ...
    private void showColumn() throws SQLException{
        ...
        try(var connection = getConnection()){
            ...
            column.ifPresent(co -> {
                System.out.printf("Coluna %s tipó %s\n", co.getName(), co.getKind());
